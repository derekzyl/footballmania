import playService from '@src/services/play';
...
export const getPracticeSessionAction = (onSuccess: () => void) => async (
  dispatch: any,
) => {
  try {
...
export const appendAnswerAction = (id: number, answer: AnsweredQuestion) => (
  dispatch: any,
  getState: any,
) => {
  try {
...
export const getAllLiveSessions = (onSuccess?: any) => async (
  dispatch: any,
) => {
  try {
